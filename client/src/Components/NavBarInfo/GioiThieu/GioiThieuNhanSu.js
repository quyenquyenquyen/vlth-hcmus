                    ...
                    <ul class="nav-menu">
                        <li>
                            <a data-scroll="cbch" href="#cbch" class="dot active">
                                <span style={{marginRight:"20px",paddingLeft:"10px",paddingRight:"10px",width:"140px",textAlign:"center"}}>Cán bộ cơ hữu</span>
                            </a>
                        </li>
                        <li>
                            <a data-scroll="cbtg" href="#cbtg" class="dot">
                                <span style={{marginRight:"20px",paddingLeft:"10px",paddingRight:"10px",width:"140px",textAlign:"center"}}>Cán bộ thỉnh giảng</span>
                            </a>
                        </li>
                    ...
                    <div class="container">
                        <div class="content-wrapper text-center">
                            <div style={{ textAlign: "center" }}>
                                <h6 id="item-1" className="title-style mt-4">CÁN BỘ CƠ HỮU</h6>
                            </div>
                                ...
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style={{width:"100px"}} scope="col">Học vị</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th scope="row">1</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Huỳnh Văn Tuấn</td>
                                            <td>PGS. TS</td>
                                        ...
                                        <tr>
                                            <th scope="row">2</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Nguyễn Huỳnh Tuấn Anh</td>
                                            <td>TS</td>
                                        ...
                                        <tr>
                                            <th scope="row">3</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Nguyễn Chí Linh</td>
                                            <td>TS</td>
                                        ...
                                        <tr>
                                            <th scope="row">4</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Hồ Văn Bình</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">5</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Huỳnh Thanh Nhẫn</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">6</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Đỗ Đức Cường</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">7</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Hứa Thị Hoàng Yến</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">8</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Phan Nguyệt Thuần</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">10</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Nguyễn Vương Thùy Ngân</td>
                                            <td>ThS</td>
                                        ...
                                        <tr>
                                            <th scope="row">11</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Nguyễn Anh Thư</td>
                                            <td>TS</td>
                                        ...
                                        <tr>
                                            <th scope="row">12</th>
                                            <td><img src='img/giaovien.png' style={{ border: '1px solid black' }} />Lâm Thị Yến</td>
                                            <td>TS</td>
