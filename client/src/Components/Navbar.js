                    ...
                    <div id="wrapper">
                        ...
                        <aside id="sidebar-wrapper">
                            ...
                            <ul class="sidebar-nav">
                                <li >
                                    <Link to="/login"><i class="fa fa-info"></i>Login</Link>
                                </li>
                                <li>
                                    <Link to="/register"><i class="fa fa-upload"></i>Register</Link>
                                </li>
                            ...
                            <nav class="navbar navbar-inverse">
                                <div class="container-fluid">
                                    <div class="navbar-header" style={{ height: "60px" }}>
                                        ...
                                        <a  class="navbar-brand" id="sidebar-toggle"  onClick={onClickLogoutHandler}>
                                            <i class="fa fa-sign-out" ></i>
                                        </a>
                                        <a href="/changePass" class="navbar-brand" id="sidebar-toggle">
                                            <i class="fa fa-user"></i>
