...
class Panigation extends React.Component {
    ...
    componentDidMount(){
        console.log('pager:', this.state.pager)
    }
    componentWillMount() {
    ...
    render() {
        ...
        return (
            <div  >
                <h6 style={{marginTop:"0.5em"}}>Page {pager.currentPage} of {pager.totalPages}</h6>

                <ul className="pagination" style={{justifyContent:"center",padding:"1.5em",margin:"0"}}>
